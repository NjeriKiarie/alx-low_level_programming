...
/**
 * binary_search - It searches for array value in array sorted array
...
/**
 * binary_search_index - its a recursive function for helping binary_search.
 * @array: pointer to the first element of the array to search in.
...
int binary_search_index(int *array, size_t l, size_t r, int value)
{
	...
	/* determine the mid-way index between index l and index r */
	mid = l + (r - l) / 2;
	...
	/**
	 * if the element MUST be in the right-portion of the portion of the
	 * array we are currently looking at, search for it in this portion
	 */
	else
